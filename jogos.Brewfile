###############################################################################
# Lista de jogos e ferramentas relacionadas a serem instalados via Homebrew   #
#                                                                             #
# INFORMAÇÕES:                                                                #
# - Organizado por categoria e ordem alfabética.                              #
# - Steam, Heroic, Lutris e Proton Plus são instalados por padrão.            #
# - Para instalar outros: remova o '#' do início da linha desejada.           #
# - Uso: execute $ brew bundle --file [caminho para jogos.Brewfile]           #
...
#flatpak "net.warsow.Warsow" # Tiro em primeira pessoa (FPS) de arena focado em movimentação rápida e acrobática
#flatpak "org.xonotic.Xonotic" # Arena shooter veloz e viciante, sucessor espiritual do Nexuiz
#flatpak "org.zdoom.GZDoom" # Engine moderna para rodar Doom e outros jogos baseados na tecnologia Doom
#flatpak "org.zdoom.Raze" # Engine para rodar jogos baseados na Build Engine como Duke Nukem 3D e Blood

# Corrida e esporte
#flatpak "net.sourceforge.ExtremeTuxRacer" # Corrida de descida na neve protagonizada pelo Tux
#flatpak "org.kde.kolf" # Jogo de minigolfe com diversos percursos e editor de mapas
#flatpak "org.kartkrew.RingRacers" # Jogo de corrida de kart altamente técnico baseado na engine de Doom
...
#flatpak "info.cemu.Cemu" # Emulador de Wii U capaz de rodar títulos em altas resoluções
#flatpak "io.github.dosbox-staging" # Versão moderna do DOSBox focada em facilidade de uso e novos recursos
#flatpak "io.github.stella_emu.Stella" # Emulador multiplataforma de Atari 2600 VCS
#flatpak "io.mgba.mGBA" # Emulador de Game Boy Advance focado em precisão e velocidade
#flatpak "net.kuribo64.melonDS" # Emulador de Nintendo DS com foco em performance
#flatpak "net.pcsx2.PCSX2" # Emulador de PlayStation 2 com suporte a melhorias gráficas
#flatpak "net.retrodeck.retrodeck" # Framework que organiza emuladores e biblioteca retro em uma interface única
#flatpak "net.rpcs3.RPCS3" # Emulador de PlayStation 3 em constante desenvolvimento
#flatpak "org.DolphinEmu.dolphin-emu" # Emulador de GameCube e Wii com alta compatibilidade
#flatpak "io.github.shiiion.primehack" # Versão modificada do Dolphin focada em Metroid Prime com controles de FPS
#flatpak "org.libretro.RetroArch" # Interface unificada para emuladores, permitindo rodar consoles clássicos via "cores"
#flatpak "org.mamedev.MAME" # Emulador de múltiplas máquinas focado na preservação histórica de hardware
#flatpak "org.ppsspp.PPSSPP" # Emulador de PSP com suporte a texturas em alta definição
#flatpak "org.scummvm.ScummVM" # Engine para rodar jogos clássicos de aventura "point-and-click"
#flatpak "rs.ruffle.Ruffle" # Emulador de Flash Player escrito em Rust para rodar conteúdos web antigos
...
#flatpak "net.veloren.veloren" # RPG de aventura em mundo aberto com gráficos em voxel (estilo Cube World)
